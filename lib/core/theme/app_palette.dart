...
class AppPalette {
  ...
  static const archive = Color(0xFF7A5C45);
  static const talkingTopic = Color(0xFF6D5B3E);
  static const listening = Color(0xFF4A7A8A); // 音声記録アーカイブ

  /// ホーム画面背景グラデーションの終端色（温かみのあるベージュ）
  static const backgroundWarm = Color(0xFFF0E9DF);
